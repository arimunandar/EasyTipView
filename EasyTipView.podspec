Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/pashaPud/EasyTipView'
  s.authors = { 'Teodor Patraș' => 'https://github.com/pashaPud' }
  s.source = { :git => 'https://github.com/pashaPud/EasyTipView', :tag => s.version }
